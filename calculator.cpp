...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
		case WM_CREATE:
			...
			buttonP = CreateWindow("Button", "+", WS_VISIBLE | WS_CHILD | WS_BORDER, 30, 125, 20,50, hwnd, (HMENU) 1, NULL, NULL);
			buttonD= CreateWindow("Button", "-", WS_VISIBLE | WS_CHILD | WS_BORDER, 90, 125, 20, 50, hwnd, (HMENU) 2, NULL, NULL);
			buttonM = CreateWindow("Button", "*", WS_VISIBLE | WS_CHILD | WS_BORDER, 150, 125, 20, 50, hwnd, (HMENU) 3, NULL, NULL);
			buttonH = CreateWindow("Button", "/", WS_VISIBLE | WS_CHILD | WS_BORDER, 210, 125, 20, 50, hwnd, (HMENU) 4, NULL, NULL);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	wc.hbrBackground = CreateSolidBrush(RGB(236, 150, 36));
